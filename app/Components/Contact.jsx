...
const Contact = () => {
  return (
    <section id="contact">
      <div className="font-rubik shadow-[#5471e457] max-md:-mt-10 max-md:mb-36 max-md:w-[90vw] rounded-2xl bg-[#ffffff7c] md:p-24 flex flex-col justify-center xl:mt-32 w-[70vw]">
